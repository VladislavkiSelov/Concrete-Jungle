    ...
    <header className="header">
      ...
      <div className="header_top container">
        ...
        <div className="location">
          <a
            target="blank"
            href="https://www.google.com/maps/place/%D0%BF%D1%80%D0%BE%D1%81%D0%BF%D0%B5%D0%BA%D1%82+%D0%9D%D0%B5%D0%B7%D0%B0%D0%BB%D0%B5%D0%B6%D0%BD%D0%BE%D1%81%D1%82%D1%96,+2,+%D0%A5%D0%B0%D1%80%D0%BA%D1%96%D0%B2,+%D0%A5%D0%B0%D1%80%D0%BA%D1%96%D0%B2%D1%81%D1%8C%D0%BA%D0%B0+%D0%BE%D0%B1%D0%BB%D0%B0%D1%81%D1%82%D1%8C,+61000/data=!4m2!3m1!1s0x4127a0dfcfc6092b:0x3c3be6e44d333002?sa=X&ved=2ahUKEwiN-tWNkaGCAxU4GBAIHeTkBC4Q8gF6BAgMEAA&ved=2ahUKEwiN-tWNkaGCAxU4GBAIHeTkBC4Q8gF6BAgQEAI"
          >
            <svg
              width="30"
              height="30"
        ...
        <div className="social_link">
          <a
            target="blank"
            href="https://www.instagram.com/kiselov_vladislav/?next=%2F"
          >
            <svg
              width="30"
              height="30"
            ...
            >
              <g id="svg 1161953_instagram_icon 1">
                <path
                  id="Vector"
                  d="M8.95216 5.30151C6.72994 5.30151 4.88867 7.11104 4.88867 9.36501C4.88867 11.619 6.6982 13.4285 8.95216 13.4285C11.2061 13.4285 13.0157 11.5872 13.0157 9.36501C13.0157 7.14278 11.1744 5.30151 8.95216 5.30151ZM8.95216 11.9682C7.52359 11.9682 6.34899 10.7936 6.34899 9.36501C6.34899 7.93643 7.52359 6.76183 8.95216 6.76183C10.3807 6.76183 11.5553 7.93643 11.5553 9.36501C11.5553 10.7936 10.3807 11.9682 8.95216 11.9682Z"
                  fill="rgb(28, 20, 15)"
                />
                <path
                  id="Vector_2"
          ...
          <a target="blank" href="https://t.me/VlaDkAaakis">
            ...
            >
              <g id="svg 8547122_telegram_plane_icon 1">
                <path
                  id="Vector"
                  d="M17.9481 3.85159L15.232 16.3047C15.0271 17.1836 14.4927 17.4024 13.7334 16.9883L9.59496 14.0235L7.59809 15.8906C7.37711 16.1055 7.19228 16.2852 6.76639 16.2852L7.06371 12.1875L14.7338 5.44924C15.0673 5.16018 14.6615 5.00002 14.2155 5.28909L4.73336 11.0938L0.651213 9.85159C-0.236733 9.58205 -0.252805 8.9883 0.836035 8.57424L16.803 2.59377C17.5423 2.32424 18.1892 2.75393 17.9481 3.85159Z"
                  fill="rgb(28, 20, 15)"
                />
              </g>
            </svg>
          ...
          <a
            target="blank"
            href="https://www.youtube.com/?app=desktop&hl=ru&gl=UA"
          >
            <svg
              width="30"
              height="30"
            ...
            >
              <g id="svg 317714_video_youtube_icon (1) 1">
                <path
                  id="Vector"
                  d="M17.8144 5.16319C17.8144 5.16319 17.6389 3.83963 17.0994 3.25688C16.4149 2.493 15.6482 2.4885 15.2966 2.44519C12.7783 2.25 9.00113 2.25 9.00113 2.25H8.99269C8.99269 2.25 5.2155 2.25 2.69775 2.44519C2.34619 2.4885 1.58006 2.493 0.894937 3.25688C0.356062 3.83963 0.18 5.16319 0.18 5.16319C0.18 5.16319 0 6.71625 0 8.26931V9.72506C0 11.2793 0.18 12.8317 0.18 12.8317C0.18 12.8317 0.3555 14.1547 0.894937 14.7364C1.58006 15.5002 2.47837 15.4772 2.87888 15.5571C4.31831 15.7044 8.99719 15.75 8.99719 15.75C8.99719 15.75 12.7783 15.7432 15.2966 15.5503C15.6482 15.5053 16.4149 15.5008 17.0994 14.7369C17.6383 14.1553 17.8144 12.8323 17.8144 12.8323C17.8144 12.8323 17.9944 11.2793 17.9944 9.72563V8.26987C17.9944 6.71625 17.8144 5.16319 17.8144 5.16319Z"
                  fill="rgb(28, 20, 15)"
                />
                <path
                  id="Vector_2"
                  d="M6.75 5.625V12.375L12.375 9L6.75 5.625Z"
                  fill="white"
                />
              </g>
            </svg>
      ...
      <div
        className={`header_bottom container ${statusHeaderBottom &&
